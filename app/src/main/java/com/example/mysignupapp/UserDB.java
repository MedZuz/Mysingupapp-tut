...
import android.database.sqlite.SQLiteDatabase;
    ...
    public class UserDB {
        ...
        private static final String TABLE_USER = "table_user"; //// infosss ala Table w colomns mteha hna relied two Vars w nsamou ala rwe7na chn7bou obviously
        ...
        private User.MaBaseSQLite maBaseSQLite;
...

        {
            ...
            maBaseSQLite = new User.MaBaseSQLite(context, NOM_BDD, null, VERSION_BDD);
        }
